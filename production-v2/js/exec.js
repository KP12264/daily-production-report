...
async function loadTrend(){
 ...
 try{
  ...
  S.trendChart=new Chart($("trendChart"),{type:"line",data:{labels,datasets:[{label:"Achievement %",data:ach,tension:.25,spanGaps:true,borderColor:"#2563eb",backgroundColor:"#2563eb",pointRadius:3}]},options:{responsive:true,maintainAspectRatio:false,scales:{y:{beginAtZero:true,suggestedMax:120}}}});
